<template>
  <div style=" margin-left: 373px;" v-masonry item-selector=".item"  horizontalOrder gutter="13" >
    <center>
...
// Funzione per generare altezza casuale tra 100 e 700 px
const randomHeight = () => Math.floor(Math.random() * 600) + 100;
