<template>
  <v-carousel style="height: 100vh;" show-arrows="hover">
    <v-carousel-item v-for="img in imgArray" :src="img" cover />
  </v-carousel>
</template>
...
<script setup>
  ...
  const imgArray = [immagine1, immagine2, immagine3, immagine4, immagine5, immagine6, immagine7, immagine8, immagine9];
</script>