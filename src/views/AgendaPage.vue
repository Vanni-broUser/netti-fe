...
useHead(generateSeoHead({
  title: 'Agenda - Netti Architetti | News e Pubblicazioni',
  description: 'Aggiornamenti, mostre, pubblicazioni e notizie dallo studio di architettura Netti Architetti di Bari.',
  slug: 'agenda',
  type: 'CollectionPage',
  breadcrumbs: [
